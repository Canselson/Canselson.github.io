...
import { CalendarDays, Images, MessageSquare, LogOut, KeyRound, FolderOpen, BarChart2, History } from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { to: '/admin/audit',    label: 'Audit Log', icon: History,      end: false },
]
